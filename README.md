...
- Clone the repository, create a new folder called env in the root directory and add a .env file with the followings (I can send the actual credentials too)
